...
st.markdown("<div style='font-size: 43px; font-weight: bold; margin-bottom: 20px;'>BTC 실시간 트레이딩</div>", unsafe_allow_html=True)
...
st.session_state.msg = f"❌ 잔고 부족! ❌️"
st.session_state.msg_type = "error"
st.rerun()
