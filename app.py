...
for p in st.session_state.positions[:]:
    ...
    target_tp = 3.5 + (max(0, abs(total_score) - 25) / 10) if st.session_state.mode == "오토" else st.session_state.tp_input
